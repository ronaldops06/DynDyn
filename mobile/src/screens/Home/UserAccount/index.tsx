        ...
        <SafeAreaView style={accountUserStyles.container}>
            <View style={accountUserStyles.viewBody}>
                ...
                <View style={[accountUserStyles.viewBlock, accountUserStyles.viewSettings]}>
                    <View style={accountUserStyles.menuItem} onTouchEndCapture={handleClickChangePassword}>
            ...
            <View style={accountUserStyles.viewAbout}>
                ...
                <Text style={accountUserStyles.abboutText}>SageMoney -
                    Versão {DeviceInfo.getVersion()} (Build {DeviceInfo.getBuildNumber()})</Text>
            </View>
        </SafeAreaView>
    );
}
