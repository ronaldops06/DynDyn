...
{
    /// <summary>
    /// Objeto de modelo da Portfolio Attribute - armazena valores de atributos para um portfólio.
    /// </summary>
    public class PortfolioAttributeModel : BaseModel
    {
        /// <summary>
        ...
        /// </summary>
        public AttributeOptionModel AttributeOption { get; set; }
        ...
        /// <summary>
        /// Portfólio associado <see cref="PortfolioModel"/>.
        /// </summary>
