...
namespace Api.Domain.Repository
{
    ...
    public interface ITransactionRepository : IRepository<TransactionEntity>
    {
        ...
        Task<Dictionary<OperationType, double>> SelectTransactionsTotalsAsync(PageParams pageParams);
        ...
        Task<IEnumerable<TransactionEntity>> SelectTransactionByParentTransactionIdAsync(int parentTransactionId);
