...
namespace Api.Service.Test.Account
{
    public class WhenExecuteDelete : AccountTest
    {
        ...
        public async Task Eh_Possivel_Executar_Metodo_Delete()
        {
            ...
            RepositoryMock.Setup(m => m.SelectByIdAsync(It.IsAny<int>(), It.IsAny<int>())).ReturnsAsync(accountEntity);
            ...
            service = new AccountService(UserServiceMock.Object, RepositoryMock.Object, Mapper);
