...
namespace Api.Service.Services
{
    public class TransactionService : BaseService, ITransactionService
    {
        ...
        private async Task GenerateRecurring(UserModel user, Period periodPreviousMonth, Period periodCurrentMonth)
        {
            ...
            foreach (var operation in operationModels)
            {
                ...
                foreach (var transaction in previousMonthTransactions)
                {
                    ...
                    await IncludeTransactionBasedPrevious(transaction);
                }
            }
        }
        ...
        private async Task IncludeTransactionBasedPrevious(TransactionEntity transaction,
            bool incrementInstallment = false)
        {
