...
namespace Api.Service.Services
{
    public class CategoryService : BaseService, ICategoryService
    {
        ...
        public async Task<PageList<CategoryModel>> Get(PageParams pageParams)
        {
            ...
            var itens = mapper.Map<List<CategoryModel>>(data.Itens);
        ...
        public async Task<CategoryModel> Put(CategoryModel categoryModel)
        {
            ...
            return mapper.Map<CategoryModel>(categoryEntity);
        }
        ...
        public async Task<bool> Delete(int id)
        {
            ...
            if (result)
                await ProcessExcludeEntityAsync(EntitiesNames.Category, id);
